...
# Title: Wifi Tx
# Generated: Thu May 28 17:48:59 2020
##################################################
...
class wifi_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, jx_sig_amp, rx_sig_out, jx_sig_out, rx_pcap_out):
        ...
        self.connect((self.foo_packet_pad2_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.foo_packet_pad2_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.foo_packet_pad2_0, 0), (self.blocks_file_sink_1, 0))
        self.connect((self.foo_packet_pad2_0, 0), (self.blocks_multiply_xx_0, 0))
